                            ...
                            @auth
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <input type="submit" class="btn btn-outline-danger"
                                        style="margin-left: 10px; margin-top: 10px;" value="{{ __('Sign Out') }}">
                                </form>
                            @else
        ...
        <div class="container">
            <div class="row">
                <div class="col custom-col">
                    ...
                    <h3 class="display-4 font-weight-lighter" style="color: #1ABCB6;">{{ __('Discover Connect Grow') }}
                    </h3>
                    <p class="lead font-weight-light text-dark" style="margin-top: 15px;">
                        {{ __('Your community for academic progress.') }}</p>
                    <div class="d-flex">
                        <a href="#about" class="btn btn-outline-danger"
                            style="margin-right: 10px; margin-top: 10px;">{{ __('More info') }}</a>
                        @if (Route::has('register'))
                            @guest
                                <!-- Only show the "Join now" button if the user is not logged in -->
                                <a href="{{ route('register') }}" class="btn btn-outline-danger"
                                    style="margin-left: 10px; margin-top: 10px;">{{ __('Join now!') }}</a>
                            @endguest

                            @auth
                                <a href="{{ route('main') }}" class="btn btn-outline-danger"
                                    style="margin-left: 10px; margin-top: 10px;">{{ __('Main') }}</a>
    ...
    <section id="about" class="pt-5" style="background-color: #f3f2f2;">
        <div class="container">
            ...
            <div class="row align-items-center mt-5">
                <div class="col-lg-6">
                    <img src="{{ asset('img/home/Girl.png') }}" class="pb-5"
                        style="height: 700px; margin-left: 40px;" alt="Girl Image">
                </div>
                <div class="col-lg-6">
                    <h2 class="font-weight-lighter" style="color: #1ABCB6;">
            ...
            <div class="row mt-5">
                <div class="col-md-4 mb-4">
                    <div class="box">
                        ...
                        <p class="lead">
                            {{ __('Connect with peers, share experiences, and build meaningful relationships.') }}</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="box">
                        ...
                        <p class="lead">
                            {{ __('Access study resources, share insights, and excel academically together.') }}</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="box">
                        <i class="fas fa-desktop fa-2x text-danger mb-3"></i>
                        <h3 class="font-weight-lighter" style="color: #1ABCB6;">{{ __('User Friendly Platform ') }}
                        </h3>
                        <p class="lead">
                            {{ __('Navigate effortlessly, engage seamlessly, and enjoy a user-friendly experience.') }}
                        </p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="box">
                        ...
                        <h3 class="font-weight-lighter" style="color: #1ABCB6;">
                            {{ __('Subject Specific Assistance') }}</h3>
                        <p class="lead">
                            {{ __('Get subject-specific help, collaborate with peers, and excel in your studies.') }}
                        </p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="box">
                        ...
                        <h3 class="font-weight-lighter" style="color: #1ABCB6;">
                            {{ __('Feedback & Continuous Improvement') }}</h3>
                        <p class="lead">
                            {{ __('Share your feedback, shape the platform, and help us improve together.') }}</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="box">
                        ...
                        <h3 class="font-weight-lighter" style="color: #1ABCB6;">
                            {{ __('Transparency & Collaboration') }}</h3>
                        <p class="lead">
                            {{ __('Join the collaboration, contribute to transparency, and shape the future together.') }}
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8 text-center">
                                    <p class="text-muted font-weight-light">
                                        {{ __('We\'d love to hear from you! Please fill out the form below and we will get in touch with you shortly.') }}
                                    </p>
                                </div>
                            </div>
                            <div class="row justify-content-center">
