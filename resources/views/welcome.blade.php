                ...
                @if (Route::has('login'))
                    ...
                    @auth
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <input type="submit" class="btn btn-outline-danger" style="margin-left: 10px; margin-top: 10px;" value="{{ __('Sign Out') }}">
                        </form>
                    @else
            ...
            <div class="row">
                <div class="col custom-col">
                    ...
                    @if (Route::has('register'))
                        ...
                        @auth
                        <a href="{{ route('main') }}" class="btn btn-outline-danger" style="margin-left: 10px; margin-top: 10px;">{{ __('Main') }}</a>
